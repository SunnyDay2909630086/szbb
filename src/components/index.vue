    ...
    <div class="index">
                            ...
                            <ul>
                                <li v-for="(item, index) in catelist" :key="item.id">
                                    <h3>
                                        ...
                                        <p >
                                            <span v-for="(subItem, index) in item.subcates"  :key="subItem.id">
                                                {{subItem.title}}&nbsp;
                                            </span>
                                    ...
                                    <div class="item-box">
                                        <dl>
                                            ...
                                            <dd>
                                                <a  v-for="(subItem, index) in item.subcates" :key="subItem.id"  href="/goods/43.html" >{{subItem.title}}</a>
        ...
        <div class="section" v-for="(item, index) in goodList" :key="item.level1cateid">
            <div class="main-tit">
                ...
                <p>
                    <a href="/goods/43.html" v-for="(itemSon, index) in item.level1cateid" :key="itemSon.subcateid">{{itemSon.subcatetitle}}</a>                 
